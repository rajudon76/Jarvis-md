...
module.exports = {
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG || "_*O Chal Nikal Kachry*_",
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_b267_a207_3ef9_7221_f604_c0d5_7b76_5ead',
  ...
  WELCOME_MSG: process.env.WELCOME_MSG || "Welcome Ho gya Mari Jaan",
  GOODBYE_MSG: process.env.GOODBYE_MSG || "Ja Wad paraan",
